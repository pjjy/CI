...
class unaudited_report_all extends FPDF
{
    ...
    function BasicTable($hb_report_unaudited_all,$conso)
    { 
          ...
          $this->SetFont('Arial','',8);
               ...
               $m_total = $hb_report_unaudited_all[3]+$prev;

               $this->Cell(16,6,$hb_report_unaudited_all[0], 1,0,'C'); 
               $this->Cell(63,6,utf8_decode(strtoupper($hb_report_unaudited_all[1])), 1,0,'L');  
               $this->Cell(63,6,$hb_report_unaudited_all[2], 1,0,'L');
               $this->Cell(18,6,number_format($prev,2), 1,0,'R');
               $this->Cell(18,6,number_format($hb_report_unaudited_all[3],2), 1,0,'R');
...
$pdf->SetTitle('Habitat Unaudited Report');
...
foreach ($hb_report_unaudited_all as  $value){
  ...
  $data = $this->Accounting_mod->hb_getdept_unaudited_all_mod($value['bunit_code'],$value['company_code']);
